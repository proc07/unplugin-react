...
import type { ImportBinding, SFCDescriptor, SFCScriptCompileOptions, ScriptCompileContext as ScriptCompileContextClass } from '@vue/compiler-sfc'

type PropsDestructureBindings = ScriptCompileContextClass['propsDestructuredBindings']
type BindingMetadata = ScriptCompileContextClass['bindingMetadata']
type ModelDecls = ScriptCompileContextClass['modelDecls']
type TypeScope = ScriptCompileContextClass['scope']

// Code source: https://github.com/vuejs/core/blob/main/packages/compiler-sfc/src/script/context.ts#L12
export class ScriptCompileContext {
  ...
  // defineModel
  modelDecls: ModelDecls = Object.create(null)
